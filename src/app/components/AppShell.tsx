        ...
        <div className="flex gap-[16px] items-center justify-center">
          <div className="flex gap-[4px] items-center px-[12px] py-[4px] rounded-[8px]" style={{ background: "linear-gradient(90deg,rgba(70,0,242,0.04) 0%,rgba(70,0,242,0.04) 100%),#fff" }}>
            <div className="flex flex-col gap-[2px] items-start">
              <span className="text-[12px] text-black/60 font-normal font-['Inter:Regular',sans-serif] leading-[14px]">Mega Dealer</span>
              <span className="text-[14px] text-black/80 font-semibold font-['Inter:Semi_Bold',sans-serif] leading-[20px]">Ford Sec 48</span>
            </div>
          </div>
